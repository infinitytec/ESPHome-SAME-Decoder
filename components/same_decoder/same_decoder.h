...
}  // namespace esphome// components/same_decoder/same_decoder.h
#pragma once
...
// Trigger template<> — no parameters; lambdas read accessors off the component.
class AlertTrigger : public Trigger<> {
 public:
  explicit AlertTrigger(SAMEDecoder *parent) { (void) parent; }
};
